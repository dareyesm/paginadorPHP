    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="right">
                ...
                $total_pages = ceil($Nbooks/$page_size);
                
                $result = $objBook->show_books($init, $page_size);
                ...
                <table border="0">
                    ...
                    if($total_pages > 1){
                        if($page != 1){
                            echo '<a href="'.URL.'admin/showBooks.php?pages='.($page - 1).'"> < </a>';
                        }
                        for($i=1;$i<=$total_pages;$i++){
                            if($page == $i){
                                echo $page;
                            }  else {
                                echo '<a href="' . URL .'admin/showBooks.php?pages='.($i) .'"> '. $i .' </a>';
                            }
                        }
                    }
                    ?></td></tr>
